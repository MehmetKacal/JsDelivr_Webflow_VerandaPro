var products, VerandaColor, VerandaMateriaalDak, verandaOptions2, verandaOptions1, glazenSchuifwand, carports, zonweringen, verandaOptions3, carportsKleur;
...
$('[bloc=next-tab]').on('click',function() {
if($('.w--tab-active').attr('data-w-tab')=='carportsKleur') {
